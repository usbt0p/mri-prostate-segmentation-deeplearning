...
# add regex to only get the t2 images and t2 labels
analyzer.regex = "t2.nii.gz"
image_paths = list(analyzer.file_paths_gen(paths["158_train"]))
...
analyzer.regex = "t2_anatomy_reader1.*"
label_paths = list(analyzer.file_paths_gen(paths["158_train"]))
